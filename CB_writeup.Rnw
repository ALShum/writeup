...
print(xtable(head(df), label="tab:df", caption="Number of  women 75 years and older with (056E) and without (057E) halth insurance in California by county from 2012 ACS 5-year data"))
@
